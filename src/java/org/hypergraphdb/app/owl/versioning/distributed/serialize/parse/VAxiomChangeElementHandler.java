...
public class VAxiomChangeElementHandler extends VOWLChangeElementHandler
{
	...
	/**
	 * Adds a parsed axiom and all associated annotations to the graph without
	 * adding it to any ontology. This is almost code duplication from
	 * HGDBOntologyInternal addAxiomByType.
	 */
	private void addAxiomToGraph()
	{
		...
		graph.getTransactionManager().ensureTransaction(new Callable<Boolean>()
		{
			public Boolean call()
			{
				...
				// 2012.01.05 hilpold copy axioms operation from onto 1 to onto
				// 2 will have axiom in graph already:
