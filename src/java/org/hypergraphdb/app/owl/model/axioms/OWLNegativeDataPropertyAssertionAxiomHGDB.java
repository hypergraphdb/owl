 ...
 * @created Nov 8, 2011
 */
public class OWLNegativeDataPropertyAssertionAxiomHGDB extends
		OWLIndividualRelationshipAxiomHGDB<OWLDataPropertyExpression, OWLLiteral> implements OWLNegativeDataPropertyAssertionAxiom
{
	...
	public OWLNegativeDataPropertyAssertionAxiomHGDB(HGHandle subject, HGHandle property, HGHandle object,
	...
	public OWLSubClassOfAxiom asOWLSubClassOfAxiom()
	{
		...
		return df.getOWLSubClassOfAxiom(df.getOWLObjectOneOf(getSubject()),
				df.getOWLObjectComplementOf(df.getOWLDataHasValue(getProperty(), getObject())));
	}
