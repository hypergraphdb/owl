 ...
 * @created Nov 8, 2011
 */
public abstract class OWLIndividualRelationshipAxiomHGDB<P extends OWLPropertyExpression<?, ?>, O extends OWLPropertyAssertionObject>
		extends OWLLogicalAxiomHGDB implements HGChangeableLink, OWLPropertyAssertionAxiom<P, O>
{
	...
	public OWLIndividualRelationshipAxiomHGDB(HGHandle... args)
	{
		...
		if (args.length != 3)
			throw new IllegalArgumentException("Args needs 3 handles. Was " + args.length);
	}

	public OWLIndividualRelationshipAxiomHGDB(HGHandle subject, HGHandle property, HGHandle object,
			Collection<? extends OWLAnnotation> annotations)
	{
		// OWLIndividual subject, P property, O object, Collection<? extends
	...
	public boolean equals(Object obj)
	{
		if (super.equals(obj))
		{
			...
			return other.getSubject().equals(getSubject()) && other.getProperty().equals(getProperty())
	...
	public void notifyTargetRemoved(int i)
	{
		...
		{ // 2 if arity 3
			objectHandle = getHyperGraph().getHandleFactory().nullHandle();
		}
	}
}