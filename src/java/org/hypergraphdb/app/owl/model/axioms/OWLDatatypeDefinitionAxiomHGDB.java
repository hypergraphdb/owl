 ...
 * @created Nov 8, 2011
 */
public class OWLDatatypeDefinitionAxiomHGDB extends OWLAxiomHGDB
		implements HGLink, OWLDatatypeDefinitionAxiom
{
	...
	public OWLDatatypeDefinitionAxiomHGDB(HGHandle datatype, HGHandle dataRange,
			Collection<? extends OWLAnnotation> annotations)
	{
		// OWLDatatype datatype, OWLDataRange dataRange, Collection<? extends
	...
	public boolean equals(Object obj)
	{
		...
		return getDatatype().equals(other.getDatatype())
				&& getDataRange().equals(other.getDataRange());
	}
