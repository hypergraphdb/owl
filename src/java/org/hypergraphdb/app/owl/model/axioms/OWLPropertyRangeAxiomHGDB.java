 ...
 * @created Nov 4, 2011
 */
public abstract class OWLPropertyRangeAxiomHGDB<P extends OWLPropertyExpression<?, ?>, R extends OWLPropertyRange> extends
		OWLUnaryPropertyAxiomHGDB<P> implements OWLPropertyRangeAxiom<P, R>
{
	...
	public R getRange()
	{
		return getHyperGraph().<R> get(rangeHandle);
	}
