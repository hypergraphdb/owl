...
//	}
	...
	/* (non-Javadoc)
	 * @see org.semanticweb.owlapi.vocab.PrefixOWLOntologyFormat#setPrefix(java.lang.String, java.lang.String)
	 */
	@Override
	...
	public void clearPrefixes() {
		...
		for (Map.Entry<String, String> prefixNameToPrefix : prefixes.entrySet()) {
			fireChange(new RemovePrefixChange(this, prefixNameToPrefix.getKey(), prefixNameToPrefix.getValue()));
		}
		super.clearPrefixes();
	}

	/* (non-Javadoc)
	 * @see org.semanticweb.owlapi.vocab.PrefixOWLOntologyFormat#setDefaultPrefix(java.lang.String)
	 */
	@Override
	...
	/**
	 * Removes a prefixname quietly, if it exists. No Events fired.
	 * Internal use only.
	 * 
	 * @param prefixName
	 */
	...
	/**
	 * Adds a prefix quietly, if not contained. No Events fired.
	 * Internal use only.
	 * 
	 * @param prefixName
	 * @param prefix
	...
	public void addPrefixChangeListener(PrefixChangeListener l) {
		if (!prefixChangeListeners.contains(l)) {
			...
			System.err.println("tried to register already listening prefixlistener: " + l);
		}
    }
	...
	/**
	 * @param isFiringChanges the isFiringChanges to set
	 */
