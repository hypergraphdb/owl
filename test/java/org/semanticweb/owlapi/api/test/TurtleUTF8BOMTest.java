...
public class TurtleUTF8BOMTest extends TestCase{
	public void testLoadingUTF8BOM() {
		...
		OWLManagerHG.createHGDBOWLOntologyManager().loadOntologyFromOntologyDocument(uri);//OWLManager.createOWLOntologyManager().loadOntologyFromOntologyDocument(uri);
		}catch (Exception e) {
