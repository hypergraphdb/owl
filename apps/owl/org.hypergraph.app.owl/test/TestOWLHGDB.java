...
import org.semanticweb.owlapi.reasoner.OWLReasonerFactory;
	...
	/**
	 * Issue sent by Boris 2012.03.01.
	 * Text:
	 * See attached test program. The main has 3 lines: 
	 * first is to create and populate HGDB, second to run the test against HGDB and 
	 * 3d to run the test against OWL files. Changes paths in the source to match your local paths. 
	 * You can get the actual ontology files from \\olsportaldev\work\cirmservices\src\ontology.
	 * The problem is the following: ontology O2 imports ontology O1. 
	 * I have an individual in O1 and I want the reasoner to give me all classes 
	 * this indivudal belongs to. If I initialize the reasoner with O1, it works no problem. 
	 * If I initialize with O2 (which imports O1), it doesn't work with HGDB, 
	 * it only works with the default OWLAPI loading the ontology from the files.
	 * 
	 * TestOWLHGDB.
	...
	{
		//public static String ONTOLOGY_DIRECTORY = "c:/work/cirmservices/src/ontology";
		...
		public static void initDatabase()
		{
			...
			HGDBOntologyRepository.setHypergraphDBLocation(databaseLocation);
		...
		{ 	
			...
			OWLOntology o1 = manager.loadOntology(IRI.create("http://www.miamidade.gov/ontology")),
					o2 = manager.loadOntology(IRI.create("http://www.miamidade.gov/cirm/legacy"));
