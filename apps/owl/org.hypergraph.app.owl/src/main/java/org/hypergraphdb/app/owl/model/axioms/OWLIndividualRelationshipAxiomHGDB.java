 ...
 * @created Nov 8, 2011
 */
public abstract class OWLIndividualRelationshipAxiomHGDB<P extends OWLPropertyExpression<?,?>, O extends OWLPropertyAssertionObject> extends OWLLogicalAxiomHGDB implements HGLink, OWLPropertyAssertionAxiom<P, O>  {
