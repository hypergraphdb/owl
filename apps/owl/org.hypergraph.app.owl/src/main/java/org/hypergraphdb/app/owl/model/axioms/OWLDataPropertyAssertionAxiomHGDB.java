 ...
 * @created Nov 8, 2011
 */
public class OWLDataPropertyAssertionAxiomHGDB extends OWLIndividualRelationshipAxiomHGDB<OWLDataPropertyExpression, OWLLiteral> implements OWLDataPropertyAssertionAxiom {

    public OWLDataPropertyAssertionAxiomHGDB(HGHandle...args) {
    	super(args);
    }

    public OWLDataPropertyAssertionAxiomHGDB(HGHandle subject, HGHandle property, HGHandle value, Collection<? extends OWLAnnotation> annotations) {
