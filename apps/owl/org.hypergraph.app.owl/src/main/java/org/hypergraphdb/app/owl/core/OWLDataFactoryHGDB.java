 ...
 * OWLDataFactortHGDB.
 * 
 * Implementing Declaration Axiom; OwlDeclarationAxiomHGDB; OWLNamedIndividualHGDB
...
//        }
	...
	public void setHyperGraph(HyperGraph graph) {
		if (graph == null) throw new IllegalArgumentException("Attempt to set graph null");
		this.graph = graph;
	}
