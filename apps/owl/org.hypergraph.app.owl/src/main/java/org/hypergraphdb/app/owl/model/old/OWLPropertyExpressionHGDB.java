...
public abstract class OWLPropertyExpressionHGDB<R extends OWLPropertyRange, P extends OWLPropertyExpression<R, P>>
		extends OWLObjectHGDB implements OWLPropertyExpression<R, P>
{
	...
	{
		//hilpold 09/14/2011 return getProperties(getEquivalentPropertiesAxioms(ontology));
	...
	{
		return Collections.emptySet();
		//hilpold 09/14/2011 return getProperties(getDisjointPropertiesAxioms(ontology));
	}
	...
	protected abstract Set<? extends OWLNaryPropertyAxiom<P>> getEquivalentPropertiesAxioms(
			OWLOntology ontology);

	protected abstract Set<? extends OWLNaryPropertyAxiom<P>> getDisjointPropertiesAxioms(
			OWLOntology ontology);

// hilpold 09/14/2011
//	private <P extends OWLPropertyExpression> Set<P> getProperties(
//			Set<? extends OWLNaryPropertyAxiom<P>> axioms)
//	{
//		Set<P> result = new TreeSet<P>();
