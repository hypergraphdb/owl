 ...
 * @created Nov 8, 2011
 */
public class OWLNegativeObjectPropertyAssertionAxiomHGDB  extends OWLIndividualRelationshipAxiomHGDB<OWLObjectPropertyExpression, OWLIndividual> implements OWLNegativeObjectPropertyAssertionAxiom {

    public OWLNegativeObjectPropertyAssertionAxiomHGDB(HGHandle...args) {
    	super(args);
    }

    public OWLNegativeObjectPropertyAssertionAxiomHGDB(HGHandle subject, HGHandle property, HGHandle object, Collection<? extends OWLAnnotation> annotations) {
