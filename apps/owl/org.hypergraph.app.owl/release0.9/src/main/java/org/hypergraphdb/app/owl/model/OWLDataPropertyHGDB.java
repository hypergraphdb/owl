 ...
 * @created Oct 3, 2011
 */
public class OWLDataPropertyHGDB extends OWLPropertyExpressionHGDB<OWLDataRange, OWLDataPropertyExpression> implements OWLDataProperty {
    private IRI iri;


    private boolean builtin;

    public OWLDataPropertyHGDB(IRI iri) {
        this.iri = iri;
