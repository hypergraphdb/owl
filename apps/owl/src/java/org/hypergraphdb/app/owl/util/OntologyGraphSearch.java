...
/**
 * OntologyGraphSearch finds all axioms connected to a non-builtin entity (e.g. an SR) by depth first search. 
 ...
 * 
 * You can subclass and overwrite shouldExplore in case you need more specific traversal semantics. 
 * 
