 ...
 * @created Nov 4, 2011
 */
public abstract class OWLPropertyDomainAxiomHGDB<P extends OWLPropertyExpression<?, ?>> extends OWLUnaryPropertyAxiomHGDB<P>
		implements OWLPropertyDomainAxiom<P>
{
	...
	{
		// P property, OWLClassExpression domain, Set<? extends OWLAnnotation>
		// annotations
