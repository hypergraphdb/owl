...
public class OWLNamedIndividualHGDB extends OWLIndividualHGDB implements
		OWLNamedIndividual
{
	private IRI iri;
	...
	{
		return OWLDataFactoryImpl.getInstance().getOWLEntity(entityType, getIRI());
	}
	...
	{
		return ImplUtils.getAnnotationAxioms(this, Collections
				.singleton(ontology));
	}
	...
	{
		return ImplUtils.getAnnotations(this, annotationProperty, Collections
				.singleton(ontology));
	}
