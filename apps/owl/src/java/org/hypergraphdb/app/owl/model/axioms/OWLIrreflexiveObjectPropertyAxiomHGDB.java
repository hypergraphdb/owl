 ...
 * @created Nov 4, 2011
 */
public class OWLIrreflexiveObjectPropertyAxiomHGDB extends OWLObjectPropertyCharacteristicAxiomHGDB implements
		OWLIrreflexiveObjectPropertyAxiom
{
	...
	public OWLSubClassOfAxiom asOWLSubClassOfAxiom()
	{
		return getOWLDataFactory().getOWLSubClassOfAxiom(getOWLDataFactory().getOWLThing(),
				getOWLDataFactory().getOWLObjectComplementOf(getOWLDataFactory().getOWLObjectHasSelf(getProperty())));
	}
