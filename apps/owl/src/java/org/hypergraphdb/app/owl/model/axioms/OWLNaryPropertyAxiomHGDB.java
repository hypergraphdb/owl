 ...
 * @created Nov 4, 2011
 */
public abstract class OWLNaryPropertyAxiomHGDB<P extends OWLPropertyExpression<?, ?>> extends OWLPropertyAxiomHGDB implements
		HGLink, OWLNaryPropertyAxiom<P>
{
	...
	{
		// Set<? extends P> properties, Collection<? extends OWLAnnotation>
		// annotations
		super(annotations);
