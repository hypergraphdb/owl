 ...
 * @created Nov 4, 2011
 */
public class OWLObjectPropertyRangeAxiomHGDB extends OWLPropertyRangeAxiomHGDB<OWLObjectPropertyExpression, OWLClassExpression>
		implements OWLObjectPropertyRangeAxiom
{
	public OWLObjectPropertyRangeAxiomHGDB(HGHandle... args)
	{
		// TODO assert arg[0] type OWLObjectPropertyExpression, args[1] type
		// OWLClassExpression
	...
	{
		// OWLObjectPropertyExpression property, OWLClassExpression range, Set<?
