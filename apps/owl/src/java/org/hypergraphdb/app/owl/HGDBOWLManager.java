...
{
	public static HGDBOntologyManagerImpl createOWLOntologyManager(String graphLocation)
	{
		HyperGraph graph = ImplUtils.owldb(graphLocation);
		return HGDBOWLManager.createOWLOntologyManager(OWLDataFactoryHGDB.get(graph), new HGDBOntologyRepository(graphLocation));
	}
