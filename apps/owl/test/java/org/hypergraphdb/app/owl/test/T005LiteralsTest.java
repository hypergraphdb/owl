 ...
 * typedLiteral := lexicalForm '^^' Datatype lexicalForm := quotedString
 * stringLiteralNoLanguage := quotedString stringLiteralWithLanguage :=
...
public class T005LiteralsTest extends OntologyManagerTest
{
	...
	{
		ManchesterOWLSyntaxEditorParser parser = new ManchesterOWLSyntaxEditorParser(m.getOWLDataFactory(), text); // takes
																													// long
																													// in
																													// HG
	...
	public void testLiterals0TypedLiteral()
	{
		...
		if (r != null)
			preDfNrLiteralsGraph = r.getNrOfAtomsByType(OWLLiteralHGDB.class);
		...
		OWLClassExpression ce1 = createClassExpr(clsExpr1); // takes extremely
															// long in HG more
															// than 3 secs
		...
		if (r != null)
			preAxNrLiteralsGraph = r.getNrOfAtomsByType(OWLLiteralHGDB.class);
		if (r != null)
			assertTrue(preAxNrLiteralsGraph == preDfNrLiteralsGraph + 7);
		// result!
		...
		m.addAxiom(o, axiom3);
		if (r != null)
			addNrLiteralsGraph = r.getNrOfAtomsByType(OWLLiteralHGDB.class);
		if (r != null)
			assertTrue(addNrLiteralsGraph == preAxNrLiteralsGraph);
		...
		if (r != null)
			remNrLiteralsGraph = r.getNrOfAtomsByType(OWLLiteralHGDB.class);
		if (r != null)
			assertTrue(addNrLiteralsGraph == remNrLiteralsGraph);
	...
	public void testLiterals0StringLiteralNoLanguage()
	{
		...
		if (r != null)
			preAxNrLiteralsGraph = r.getNrOfAtomsByType(OWLLiteralHGDB.class);
		if (r != null)
			assertTrue(preAxNrLiteralsGraph == preDfNrLiteralsGraph + 4);
		// result!
	...
	public void testLiterals0StringLiteralWithLanguage()
	{
		...
		// FOUND PARSER ERROR ON LITERAL l2: getLiteral returns xxxxxx@x ==8,
		// should be 6..
		assertTrue(l2.getLang().equals(""));
